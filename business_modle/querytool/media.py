...
def tmpdaylist(days):
    ...
    return str(daylist)
def ad_biddingpara():
    param={'pids':1,'uniq_tag':'fdfafd','ip':'117.157.52.195','cookie':'fdsafdfdaaad',
           'device':'117.157.98.117','adzone_id':102,'pos_num':'1_0','act_id':100}
...
def ad_bidding_brige():
    ...
    brigeparam={'ip':'117.157.98.117','agent':'Mozilla%2F5.0+%28Windows+NT+10.0%3B+WOW64%29+AppleWebKit%2F537.36+%28KHTML%2C+like+Gecko%29+Chrome%2F52.0.2729.4+Safari%2F537.36'
                ,'refer':'http%3A%2F%2Ft.ijifen.egou.com%3A8080%2Factivity%2F1.htm%3FlogId%3D24&','mediaId':1
                ,'adZoneId':'102','adPlanId':'3','adCreativeId':'10','userCookie':'','chargeType':'4','adzoneClickId':'111'
                ,'isCharge':'1','logType':'2','positionId':'1','adLinkUrl':'http://www.baidu.com','actId':'577'
    ...
    brigeparam['chargeType']=r.json()['data']['{"id":1,"positionSize":"640x300","positionType":1,"occurrenceTime":0}'][0]['adOrder']['paymentMode']
