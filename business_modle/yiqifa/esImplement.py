...
def renderingSource(tmp,campaign_id,results):
    ...
    for rs in results:
        ...
        # if campaign_id==2060:
        tmpdict["advertiserName"]="淘宝网"
        # else:
        #     tmpdict["advertiserName"] = "2"  #getEsByProductId(rs[3])
...
def getEsByProductId(productId):
  ...
  "query": {
   "bool":{
    ...
    return analysisEsByYiqifa(res)

#根据dataSource和actionNo查询【Es】数据
